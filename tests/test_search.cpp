...
TEST_CASE("LMR: finds Qg6 in WAC.001 (forced tactical win, depth 8)") {
    ...
    // (Depth raised from 7 to 8 after PeSTO eval was introduced; the position is
    //  still a forced tactical win, just scored slightly differently at shallower
    //  depths by the richer eval.)
    Position p;
